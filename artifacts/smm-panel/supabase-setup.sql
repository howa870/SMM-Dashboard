...
alter table public.profiles add column if not exists total_bonus numeric(10,2) not null default 0;
...
-- Referral earnings table (commissions paid out)
...
-- Transactions table (records deposits + bonuses)
...
-- ============================================================
-- INCREMENT BALANCE FUNCTION (needed by referral commission)
-- ============================================================
create or replace function public.increment_balance(uid uuid, amount numeric)
returns void
language plpgsql
